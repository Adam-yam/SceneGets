...
object WidgetColors {
    ...
    val pageBackground = ColorProvider(R.color.widget_page_background)
    ...
    val pinkTint = ColorProvider(R.color.widget_pink_tint)
    val downTint = ColorProvider(R.color.widget_down_tint)
}
